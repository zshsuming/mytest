...
//			R.drawable.ic_category_80, R.drawable.ic_category_none };
	...
	// 第一个菜单
		public static String[] LISTVIEWTXT = new String[] { "银行卡", "个人理财", "代理保险" };
		// 第一个菜单子菜单
		public static String[][] MORELISTTXT = {
				...
				{ "中国人寿", "安邦保险", "正德保险" } };
		// 第二个菜单
		public static String[] SHOPLIST_TOPLIST = new String[] { "电子银行", "对公理财" };
		// 第二个菜单子菜单
		public static String[][] SHOPLIST_PLACESTREET = new String[][] {
				{ "网上银行", "手机银行" },
				{ "滚动型", "养老金", "非保本" } };
		// 第三个菜单
		public static String[] SHOPLIST_THREELIST = { "佛教", "生肖", "星座" };
		// 第四个菜单
		public static String[] PAIHANGBANG_TOPLIST = new String[] { "新品上架", "优惠活动", "优惠活动" };
		// 第N个菜单
